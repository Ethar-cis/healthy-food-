...
class oversub extends StatefulWidget {
  const oversub({Key? key}) : super(key: key);
  
  @override
  State<oversub> createState() => _oversub();

}
class _oversub extends State<oversub> {
      ...
      body:Center(child:
       SingleChildScrollView(
        child: Column(
          ...
          image: const DecorationImage(image: AssetImage('images/ov1.jpeg'), fit: BoxFit.cover,)),
